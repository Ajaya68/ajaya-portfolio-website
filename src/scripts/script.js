...
(function () {
  ...
  var tools = [
    ...
    { name: 'Advanced Java', /*role: 'Cloud Basics',*/ color: '#FF9900' },
    ...
    { name: 'React.js', role: 'Frontend Framework', color: '#D33833' },
  ];
  ...
  var projects = [
    {
      ...
      description:
        "Designed and developed an enterprise-level payroll database system using Oracle Corporation SQL and PL/SQL. Created normalized database schema with 10+ relational tables for employee, department, attendance, leave, tax, bonus, and payroll management.",
    ...
    },
    {
      ...
      tags: ["Oracle SQL", "PL/SQL"],
      description:
        "Designed and implemented a normalized banking database schema for customers, accounts, transactions, branches, and loans using Oracle Corporation SQL. Developed stored procedures for deposit processing, account updates, and transaction report generation.",
    ...
    },
    {
      ...
      description:
        "Built and deployed an ML classification model to predict diabetes risk based on patient health parameters. Applied data preprocessing, feature scaling and model evaluation.",
    ...
    },
    {
      ...
      description: 'Developed a responsive e-commerce web application using React.js, Bootstrap 5, HTML5, CSS3, and JavaScript (ES6+).',
      link: 'https://ajaya68.github.io/LUMINA-ECOMMERCE-WEBSITE/'
    },
    // {
  ...
  var certificates = [
    ...
    },
    {
      ...
      link: "https://www.hackerrank.com/certificates/c78144091e76",
    },
    {
      title: "React",
      issuer: "HackerRank",
  ...
  function renderProjects() {
    ...
    projects.forEach(function (p) {
      ...
      p.tags.forEach(function (t) {
        tagsWrap.appendChild(el("span", { class: "chip" }, t));
      });
    ...
    certificates.forEach(function (c) {
      ...
      card.appendChild(
        el(
          "div",
          { class: "card-media" },
          el("img", { src: c.image, alt: c.title, loading: "lazy" }),
        ),
      );
      var body = el("div", { class: "card-body-2" });
      var head = el("div", { class: "card-head" }, [
